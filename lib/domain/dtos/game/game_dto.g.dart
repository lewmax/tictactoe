...
GameDto _$GameDtoFromJson(Map<String, dynamic> json) => GameDto(
      ...
      endedAt:
          FirebaseDateConverter.datetimeMapFromJsonNullable(json['endedAt']),
      owner: GameUserDto.fromJson(json['owner'] as Map<String, dynamic>),
      opponent: json['opponent'] == null
          ? null
          : GameUserDto.fromJson(json['opponent'] as Map<String, dynamic>),
      ...
      boardMap: GameConverter.boardMapFromJson(
          json['boardMap'] as Map<String, dynamic>),
    );
...
Map<String, dynamic> _$GameDtoToJson(GameDto instance) => <String, dynamic>{
      ...
      'endedAt':
          FirebaseDateConverter.datetimeMapToJsonNullable(instance.endedAt),
