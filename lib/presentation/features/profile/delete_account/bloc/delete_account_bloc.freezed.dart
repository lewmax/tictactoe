...
class _$DeleteAccountImpl implements _DeleteAccount {
  const _$DeleteAccountImpl(this.password);
  ...
  @override
  String toString() {
    return 'DeleteAccountEvent.deleteAccount(password: $password)';
  }
...
abstract class _DeleteAccount implements DeleteAccountEvent {
  const factory _DeleteAccount(final String password) = _$DeleteAccountImpl;
